...
const AboutUs = () => {
  useEffect(() => {
    document.title = "About Us | Tech Binders";
  }, []);
    ...
    <div className="page-container">
      <section className="page-header" style={{padding: '120px 0 60px 0', background: 'linear-gradient(to bottom, var(--bg-card), var(--bg))'}}>
        <div className="container">
          ...
          <h1 className="hero-title reveal delay-1">Building Digital Solutions for <span className="gradient-text">Modern Businesses</span></h1>
      ...
      <section style={{padding: '80px 0', background: 'var(--bg-card)'}}>
        <div className="container" style={{textAlign: 'center'}}>
          <div className="section-header reveal centered">
            ...
            <p className="section-subtitle">We are a recognized and registered organization.</p>
          </div>
          
          <div className="reveal delay-1" style={{display: 'flex', gap: '20px', justifyContent: 'center', flexWrap: 'wrap', marginTop: '40px'}}>
            <a href="/assets/UDYAM%20CERTIFICATE%20WITH%20ANNEXURE.pdf" target="_blank" rel="noopener noreferrer" className="btn-secondary" style={{display: 'flex', alignItems: 'center', gap: '10px', background: 'var(--bg-alt)'}}>
              <i className="fas fa-file-pdf" style={{fontSize: '1.2rem', color: 'var(--red-primary)'}}></i>
              Udyam Certificate (With Annexure)
            </a>
            <a href="/assets/UDYAM%20CERTIFICATE%20WITHOUT%20ANNEXURE.pdf" target="_blank" rel="noopener noreferrer" className="btn-secondary" style={{display: 'flex', alignItems: 'center', gap: '10px', background: 'var(--bg-alt)'}}>
              <i className="fas fa-file-pdf" style={{fontSize: '1.2rem', color: 'var(--red-primary)'}}></i>
              Udyam Certificate (Without Annexure)
            </a>
          </div>
        </div>
      </section>
